<template>
  <section class="my-8 max-w-7xl m-0 m-auto">
    <h2 class="text-black text-2xl mb-6">HỆ THỐNG CỬA HÀNG BITIS</h2>
    <div class="flex flex-col md:flex-row gap-6">
      <!-- List location -->
      <div class="md:w-96 w-full bg-white rounded shadow p-4 h-[480px] flex-shrink-0 overflow-auto">
...
const filteredStores = computed(() =>
  selectedProvince.value
    ? stores.filter(x => x.province === selectedProvince.value)
    : stores
)
