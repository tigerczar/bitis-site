<template>
  ...
  <header class="hidden md:block bg-white border-b">
    <!-- topbar -->
    <div class="bg-[#24232A] text-white text-xs flex justify-between items-center px-8 py-2">
    ...
    <!-- main menu -->
    <div class="flex items-center justify-between px-6 py-2 borer border-yellow">
      <NuxtLink to="/">
        <img src="/images/bitis-logo.svg" alt="Bitis logo" class="h-12" width="120" height="48" decoding="async" />
      </NuxtLink>
      <nav v-if="isClient" class="flex items-center gap-6 uppercase text-[#24232A] text-sm">
      ...
      <div class="flex items-center gap-4">
        <div class="flex items-center bg-gray-100 py-[5px] rounded-[5px]">
          <button class="ml-2">
          ...
          <input class="bg-transparent outline-none text-sm px-1" placeholder="Bạn cần tìm gì..." />
        </div>
        <NuxtLink to="/">
          <svg class="svg-ico-account" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
            <g>
        ...
        <NuxtLink to="/">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" class="svg-ico-wishlist" version="1.1" width="24" height="24" x="0" y="0" viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
            <g>
        ...
        <NuxtLink to="/">
          <svg class="svg-ico-cart" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 32 32" style="enable-background: new 0 0 512 512" xml:space="preserve">
            <g>
              <g xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2">
                <path d="m16 17.82a6 6 0 0 1 -5.89-4.82 1 1 0 0 1 1-1.15 1 1 0 0 1 1 .83 4 4 0 0 0 7.83 0 1 1 0 0 1 1-.83 1 1 0 0 1 1 1.15 6 6 0 0 1 -5.94 4.82z" fill="#000000" data-original="#000000" class=""></path>
                <path d="m24.9 31h-17.8a3 3 0 0 1 -3-3.15l.81-17.24a3 3 0 0 1 3-2.87h16.18a3 3 0 0 1 3 2.87l.81 17.24a3 3 0 0 1 -3 3.15zm-16.99-21.25a1 1 0 0 0 -1 1l-.81 17.2a1 1 0 0 0 1 1.05h17.8a1 1 0 0 0 1-1.05l-.81-17.24a1 1 0 0 0 -1-1z" fill="#000000" data-original="#000000" class=""></path>
                <path d="m22 8.75h-2v-1.75a4 4 0 0 0 -8 0v1.75h-2v-1.75a6 6 0 0 1 12 0z" fill="#000000" data-original="#000000" class=""></path>
              </g>
            </g>
          </svg>
          <!-- <span class="absolute -top-2 -right-2 bg-black text-white text-[10px] rounded-full w-5 h-5 flex items-center justify-center">0</span> -->
  ...
  <header class="md:hidden bg-white border-b">
    <div class="flex items-center justify-between px-4 py-2">
      <button @click="openDrawer()">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path d="M20 12L4 12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M20 17L4 17" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
          </g>
        </svg>
      </button>
      <div class="flex align-center items-center">
        <img src="/images/vn-flag.svg" alt="VN" class="h-4" loading="lazy" decoding="async" />
        <!-- <span class="ml-1">VN</span> -->
        <select class="bg-transparent text-black text-[13px]">
          <option value="vn">VN</option>
          <option value="en">EN</option>
        </select>
      </div>
      ...
      <div class="flex gap-3">
        <NuxtLink to="/">
          <!-- <svg width="24" height="24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4" stroke-width="2"/><path stroke-width="2" d="M4 20c0-3.314 3.582-6 8-6s8 2.686 8 6"/></svg> -->
          <svg class="svg-ico-account" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
            <g>
              <g xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <NuxtLink to="/" class="relative">
          <!-- <svg width="24" height="24" fill="none" stroke="currentColor"><path d="M12 21l-1.45-1.32C5.4 15.36 2 12.28 2 8.5c0-2.5 2-4.5 4.5-4.5a5.8 5.8 0 0 1 5.5 3.36A5.8 5.8 0 0 1 17.5 4C20 4 22 6 22 8.5c0 3.78-3.4 6.86-8.55 11.18z" stroke-width="2"/></svg> -->
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" class="svg-ico-wishlist" version="1.1" width="24" height="24" x="0" y="0" viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
            <g>
              <g xmlns="http://www.w3.org/2000/svg" id="_1_Heart" data-name="1 Heart">
                <path
        ...
        <NuxtLink to="/">
          ...
          <!-- <svg width="24" height="24" fill="none" stroke="currentColor"><path d="M3 3h2l.344 4M7 13h10l4-8H5.344L7 13zM16 21a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" stroke-width="2"/>
        </svg> -->
          <!-- <span class="absolute -top-2 -right-2 bg-black text-white text-[10px] rounded-full w-5 h-5 flex items-center justify-center">0</span> -->
        </NuxtLink>
      </div>
